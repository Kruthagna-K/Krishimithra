...
PIN code: &nbsp;$rs[pincode]</td>
							    ...
							    <td>&nbsp;$rs[status]</td>
							    <td>&nbsp; <a href='customerReg.php?editid=$rs[customer_id]' class='btn btn-info'>Edit</a>| <a href='viewcustomerReg.php?deleteid=$rs[customer_id]' onclick='return delconfirm()' class='btn btn-danger'>Delete</a></td>
						      </tr>";
							  }
							  ?>
								</TBODY>

...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="UPDATE state SET `state`='$_POST[state]', `description`='$_POST[description]', `status`='Active' where state_id='$_GET[editid]'";
	...
	{
		$sql="INSERT INTO `state`( `state`, `description`, `status`) VALUES ('$_POST[state]','$_POST[description]','Active')";	
		if(!mysqli_query($con,$sql))
		{
			echo "Error in mysqli query";
		}
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4>Enter State Detail...</h4></center><hr>

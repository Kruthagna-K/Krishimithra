...
{
		$sql ="UPDATE customer SET  `customer_name`='$_POST[customername]', `address`='$_POST[address]', `state_id`='$_POST[state]', `city_id`='$_POST[city]', `pincode`='$_POST[pincode]', `contact_no`='$_POST[cntctnum]', `mobile_no`='$_POST[mblnum]', `email_id`='$_POST[email_id]',  `customer_type`='$_POST[customertype]', `status`='$_POST[status]' WHERE customer_id='$_SESSION[customerid]'";
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4>Keep Your Profile Updated Here..</h4></center>
